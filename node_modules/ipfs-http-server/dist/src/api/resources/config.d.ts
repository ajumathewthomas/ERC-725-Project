export namespace getOrSet {
    ...
    function handler(request: any, h: any): Promise<any>;
    function handler(request: any, h: any): Promise<any>;
}
export namespace get {
    ...
    export function handler(request: any, h: any): Promise<any>;
}
export namespace show {
    ...
    export function handler_1(request: any, h: any): Promise<any>;
...
export namespace replace {
    export namespace options_6 {
        ...
        const pre_1: {
            assign: string;
            method: (request: any, _h: any) => Promise<{
                config: any;
            }>;
        }[];
        export { pre_1 as pre };
...
export namespace profiles {
    namespace apply {
        ...
        export function handler_2(request: any, h: any): Promise<any>;
    ...
    namespace list {
        ...
        export function handler_3(request: any, h: any): Promise<any>;

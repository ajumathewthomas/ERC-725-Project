declare function _exports(config: any): {
    ...
    write: (path: string, input: string | Blob | Uint8Array | AsyncIterable<Uint8Array>, options?: (import("ipfs-core/src/components/files/write").WriteOptions & import("ipfs-core/src/utils").AbortOptions & import("..").HttpOptions) | undefined) => Promise<void>;
};
export = _exports;

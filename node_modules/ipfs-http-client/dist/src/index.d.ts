...
declare function ipfsClient(options?: import("./lib/core").ClientOptions): {
    ...
    bitswap: {
        wantlist: (options?: (import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<import("cids")[]>;
        wantlistForPeer: (peerId: string | Uint8Array | import("cids") | import("peer-id"), options?: (import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<import("cids")[]>;
        ...
        unwant: (cid: import("cids") | import("cids")[], options?: (import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<void>;
    };
    block: {
        get: (cid: string | Uint8Array | import("cids"), options?: (import("ipfs-core/src/components/block/get").GetOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<any>;
        stat: (cid: import("cids"), options?: (import("ipfs-core/src/components/block/stat").StatOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<import("ipfs-core/src/components/block/stat").Stat>;
        put: (data: any, options?: (import("ipfs-core/src/components/block/put").PutOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<any>;
        rm: (cid: import("cids") | import("cids")[], options?: (import("ipfs-core/src/components/block/rm").RmOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => AsyncIterable<import("ipfs-core/src/components/block/rm").RmSucceess | import("ipfs-core/src/components/block/rm").RmFailure>;
    };
    bootstrap: {
    ...
    cat: (path: string | import("cids"), options?: (import("ipfs-core/src/components/cat").CatOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => AsyncIterable<Uint8Array>;
    commands: (options?: {}) => Promise<any>;
    config: {
        getAll: import("./interface").APIWithExtraOptions<import("ipfs-core/src/components/config").GetAll, HttpOptions>;
        get: import("./interface").APIWithExtraOptions<import("ipfs-core/src/components/config").Get, HttpOptions>;
        set: import("./interface").APIWithExtraOptions<import("ipfs-core/src/components/config").Set, HttpOptions>;
        replace: import("./interface").APIWithExtraOptions<import("ipfs-core/src/components/config").Replace, HttpOptions>;
        profiles: {
    ...
    dag: {
        get: import("./interface").APIWithExtraOptions<(ipfsPath: import("cids"), options?: (import("ipfs-core/src/components/dag/get").GetOptions & import("ipfs-core/src/utils").AbortOptions) | undefined) => Promise<import("ipfs-core/src/components/dag/get").DagEntry>, HttpOptions>;
        put: import("./interface").APIWithExtraOptions<(dagNode: any, options?: (import("ipfs-core/src/components/dag/put").PutOptions & import("ipfs-core/src/utils").AbortOptions) | undefined) => Promise<import("cids")>, HttpOptions>;
        resolve: import("./interface").APIWithExtraOptions<(ipfsPath: string | import("cids"), options?: (import("ipfs-core/src/components/dag/resolve").ResolveOptions & import("ipfs-core/src/utils").AbortOptions) | undefined) => Promise<import("ipfs-core/src/components/dag/resolve").ResolveResult>, HttpOptions>;
    };
    dht: {
        ...
        findProvs: (cid: import("cids"), options?: (import("ipfs-core/src/components/dht").FindProvsOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => AsyncIterable<import("ipfs-core/src/components/dht").PeerInfo>;
        findPeer: (peerId: import("cids") | import("peer-id"), options?: (import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<{
            id: string;
            addrs: import("multiaddr")[];
        }>;
        provide: (cids: import("cids") | import("cids")[], options?: (import("ipfs-core/src/components/dht").ProvideOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => AsyncIterable<import("ipfs-core/src/components/dht").QueryEvent>;
    ...
    files: {
        ...
        cp: (...args: [a1: string | import("cids"), options?: (import("ipfs-core/src/components/files/cp").CpOptions & HttpOptions) | undefined] | [a1: string | import("cids"), a2: string | import("cids"), options?: (import("ipfs-core/src/components/files/cp").CpOptions & HttpOptions) | undefined] | [a1: string | import("cids"), a2: string | import("cids"), a3: string | import("cids"), options?: (import("ipfs-core/src/components/files/cp").CpOptions & HttpOptions) | undefined]) => Promise<void>;
        flush: (path: string, options?: (import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<import("cids")>;
        ...
        read: (path: string | import("cids"), options?: (import("ipfs-core/src/components/files/read").ReadOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => AsyncIterable<Uint8Array>;
    ...
    get: (path: string | import("cids"), options?: (import("ipfs-core/src/components/get").GetOptions & import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => AsyncIterable<import("ipfs-core/src/utils").File | import("ipfs-core/src/utils").Directory>;
    getEndpointConfig: () => {
        host: string;
        port: string;
        protocol: string;
    ...
    id: (options?: (import("ipfs-core/src/utils").AbortOptions & HttpOptions) | undefined) => Promise<import("ipfs-core/src/components/id").PeerId>;
    key: {
